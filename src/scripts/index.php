...
<body>
  <div id="background">
    <video loop autoplay muted> <!--Video mutado carregando automatico em loop infinito-->
    <source src="../assets/background-video.mp4" type="video/mp4"> <!--Video do Mario, tipo mp4 -->
    </video>
  </div>

  <div id="app">
    <header>
      <img src="../assets/logo-cap-zero.png" alt="">
        ...
        <div class="navigation__social">
          <svg class="navigation__social__icone" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
          ...
          <svg class="navigation__social__icone" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512">
          ...
          <svg class="navigation__social__icone" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512">
    ...
    <main>
      <div class="main__info">
        ...
        data-aos-easing="ease-in-out"
        >
          No futuro, em meio a crescentes tensões entre humanos e androides, os irmãos Mega Man e Zero enfrentam uma ameaça sem precedentes
          uma civilização alienígena determinada a destruir a humanidade. Enfrentando inimigos poderosos, batalhas espaciais e traições surpreendentes
          eles lutam para deter os planos nefastos dos invasores e salvar não apenas a Terra, mas todo o universo conhecido.
        </p>
      ...
      <img
        ...
        data-aos-duration="800"
        data-aos-easing="ease-in-out"
        src="../assets/logo-zero-e.png" alt=""
      >
    </main>
  </div>
